...
class MalePersonHeight extends StatefulWidget {


  @override
  State<MalePersonHeight> createState() => _PersonHeightState();
}

class _PersonHeightState extends State<MalePersonHeight> {
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Image(
                      fit: BoxFit.cover,
                      image: NetworkImage('https://img.freepik.com/free-vector/happy-man-standing-white-background_1308-74038.jpg'),
                    ),
                  ),
                  Container(
                    height: 400.h,
